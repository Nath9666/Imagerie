...
int main(int argc, char **argv)
{
  ...
  if(argc != 3)
  {
    ...
    fprintf(stderr,"Median Filtering B&W image \n");
    exit(0);
  }
  /* --- Source Image --- */
...
/* --- Example of Image Scan using 3 by 3 neighbourhood --- */
  ...
  if (ret)
  {
    fprintf(stderr,"Problem of Memory Allocation in Median Filtering \n");
    exit(0);
  } 
...
/* --- Free of Images --- */
  ...
  fprintf(stderr,"End of EdMedianFiltering Operator\n");
}
